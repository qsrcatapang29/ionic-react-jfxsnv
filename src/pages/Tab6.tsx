import './Tab6.css';  // Make sure to import the CSS for styling
...
const Tab6: React.FC = () => (
  <IonPage>
    ...
    <IonContent className="ion-padding page-background"> {/* Add the page-background class */}
      ...
      <IonButton expand="block" routerLink="/tab7" className="custom-ion-button success">
  Easy
</IonButton>
<IonButton expand="block" routerLink="/tab8" className="custom-ion-button warning">
  Medium
</IonButton>
<IonButton expand="block" routerLink="/tab9" className="custom-ion-button danger">
  Hard
</IonButton>
